  ...
  const [resumeData, setResumeData] = useState([
    {
      ...
      description: ['Developed the Dietitian Dashboard using React and Typescript, streamlining clinicians" access to patient data via user-friendly timelines, detailed charts, and organized data cards',
      ...
      technologies: ['ReactJS', 'SCSS', 'Javscript', 'Typescript', 'Kotlin Multiplatform'],
    ...
    },
   {
    title: 'IOS Engineer - SIZZLE',
      ...
      description: ['Collaborated in a cross-functional team of 4 to create a versatile, cross-platform app facilitating communication between dietitians and patients for gut health and weight management.',
