      ...
      <div className="projects-content">
        ...
        <div className = "chat-application">
            ...
            <div className="project-tile">
                <img src={chatLogin} alt="Chat Login" className='project-overlay' />
             </div>

             <div className="project-tile">
                <img src={chatLobby} alt="Chat Lobby" className='project-overlay' />
            </div>
        </div>
        ...
        <div className="project-link">
         <a href="https://github.com/boney171/Messenger-Chat-App" target="_blank">Click Here</a>
